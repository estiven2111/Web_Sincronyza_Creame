...
const Gastos = () => {
  ...
  const peticionOcr = async () => {
    ...
    try {
      ...
      const iva = !responsedata.ivaPorc || !responsedata.totalSinIva ? "" : `${responsedata.totalSinIva*responsedata.ivaPorc/100}`
     const rete =  !responsedata.retePorc || !responsedata.totalSinIva ? "" : `${responsedata.totalSinIva*responsedata.retePorc/100}`
      setResponsedata({
        ...responsedata,
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-12 mx-auto">
              ...
              <div className="mx-auto text-center h-90 mb-14 rounded-lg ">
                <div className="rounded-lg grid grid-cols-1 bg-blue-300/50 ">
                  <div className=" col-span-1  flex items-center justify-center mb-5">
                    <img className="w-72 h-72 rounded-t-lg" src={imageSrc} alt="" />
                  </div>
            ...
            <>
              <div className="h-96 bg-blue-300/50 flex items-center justify-center border-2 border-black m-5 lg:m-0 ">
                <div className=" rounded-lg ">
                  ...
                  <div className="w-28">
                    <label
                      className="hover:bg-slate-300    flex flex-col items-center justify-center border-2 rounded-full border-gray-700 border-dashed  cursor-pointer bg-gray-50"
                    >
          ...
          <div className="grid lg:grid-cols-4 grid-cols-2 gap-4  mx-auto border-2 border-black bg-slate-200/50 p-2">
            ...
            <div className="flex items-center justify-center col-span-1 ">
              ...
              >
                <input
                value={fillData ? !responsedata.ivaPorc || !responsedata.totalSinIva ? "" : `${responsedata.totalSinIva*responsedata.ivaPorc/100}` : ""}
                name="iva"
                onChange={handleOnChange}
                  type="number"
                  className="peer block min-h-[auto] w-full rounded border-0 bg-blue-300/50 px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none "
            ...
            <div className="flex items-center justify-center col-span-1">
             ...
             <div
              ...
              >
                <input
                value={fillData ? !responsedata.retePorc || !responsedata.totalSinIva ? "" : `${responsedata.totalSinIva*responsedata.retePorc/100}` : ""}
                name="rete"
                onChange={handleOnChange}
                  type="number"
                  className="peer block min-h-[auto] w-full rounded border-0 bg-blue-300/50 px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none "
